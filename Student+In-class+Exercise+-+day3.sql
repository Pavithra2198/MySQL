...
alter table bank_inventory_pricing rename column month1 to month;
...
select distinct * from  Bank_Inventory_pricing;
...
select month,sum(purchase_cost),avg(estimated_sale_price) from Bank_inventory_pricing where month=2;
-------------------------------------------------------------------------------------------------------------
# Question 2:
# 2) Print average of estimated_sale_price with two decimals from bank_inventory_pricing table.
select avg(estimated_sale_price),round(avg(estimated_sale_price),2) from Bank_inventory_pricing;
-------------------------------------------------------------------------------------------------------------
# Question 3:
# 3) Print the Products which are appearing in bank_inventory_pricing more than once during the month : 1
select product,month,count(*) from bank_inventory_pricing where month=1 group by product having count(*)>1;
-------------------------------------------------------------------------------------------------------------
# Question 4:
...
select product,count(product), month from bank_inventory_pricing 
where purchase_cost>ifnull(estimated_sale_price,0) group by product having count(product)>1;
-------------------------------------------------------------------------------------------------------------
# Question 5:
# 5) Print the sum of  purchase_cost of Bank_Inventory_pricing table with default value of 2000/-
# if not updated with any value
select sum(ifnull(purchase_cost,2000)) sum_of_pc from bank_inventory_pricing   ;
-------------------------------------------------------------------------------------------------------------
# Question 6:
...
select product,max(purchase_cost),min(purchase_cost),max(purchase_cost)-min(purchase_cost)
...
select * from Bank_inventory_pricing;
select sum(purchase_cost),month from bank_inventory_pricing group by month limit 2;
-------------------------------------------------------------------------------------------------------------
# Question 11:
...
from bank_inventory_pricing where purchase_cost is null group by product;
-------------------------------------------------------------------------------------------------------------
# Question 14:
...
-------------------------------------------------------------------------------------------------------------
# Question 17:
# 17) Print product with an increase in  average of estimated_sale_price  by 15% when average product_cost 
-- is more than average estimated_sale_price
select product, avg(estimated_sale_price+((estimated_Sale_price)*(15/100))) as avg_es 
...
select product,avg(price),count(distinct month) from bank_inventory_pricing 
group by product having count(distinct month)=3;